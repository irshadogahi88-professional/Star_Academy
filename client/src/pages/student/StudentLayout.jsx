...
const navItems = [
  { name: 'Dashboard', path: '/dashboard', icon: <GraduationCap size={18} /> },
  { name: 'Lectures & Notes', path: '/dashboard/lectures', icon: <BookOpen size={18} /> },
  { name: 'Online Tests', path: '/dashboard/tests', icon: <ClipboardList size={18} /> },
  { name: 'Fee Challan', path: '/dashboard/challan', icon: <Receipt size={18} /> },
  { name: 'AI Analytics', path: '/dashboard/analytics', icon: <TrendingUp size={18} /> },
        ...
        <div className="p-4 mx-4 my-4 rounded-2xl bg-[#0a1b14]/50 border border-[#10b981]/15 backdrop-blur-xl space-y-3">
          ...
          <div className="pt-2 border-t border-[#10b981]/10 flex items-center justify-between text-xs">
            ...
            {student.status === 'approved' ? (
              ...
              <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase text-amber-400 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-500/20">
            ...
            <div>
              <div className="p-4 border-b border-[#10b981]/15 flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-amber-500 uppercase font-bold">Grade {student.class}</p>
                </div>
              </div>
