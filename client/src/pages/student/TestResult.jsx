    ...
    <div className="min-h-screen bg-[#08140f] pb-12 flex flex-col items-center selection:bg-emerald-500/20 text-emerald-100">
      ...
      <div className="px-4 w-full max-w-4xl mb-12">
        <div className="card-glass bg-[#0a1b14]/50 border border-[#10b981]/15 rounded-[2rem] p-8 sm:p-12 text-center shadow-2xl relative overflow-hidden">
          ...
          <p className="text-emerald-100/50 mb-8 text-base font-bold uppercase tracking-widest">Performance Report</p>
      ...
      {showAnswersAtEnd ? (
        <div className="max-w-4xl w-full px-4">
          <h3 className="text-2xl font-black text-white mb-8">Detailed Answer Review</h3>
                ...
                <div key={mcq._id || mcq.id} className="card-glass bg-[#0a1b14]/50 border border-[#10b981]/15 p-6 sm:p-8 rounded-3xl relative overflow-hidden">
                  ...
                  <div className="space-y-3 pl-4 mb-6">
                    {mcq.options.map((opt, optIdx) => {
                      ...
                      if (isActualCorrect) {
                        style = "border-emerald-500 bg-emerald-500/10 text-emerald-400 font-bold shadow-sm animate-pulse"
        ...
        <div className="max-w-3xl w-full px-4">
          <div className="card-glass bg-[#0a1b14]/50 border border-[#10b981]/15 p-10 rounded-3xl text-center space-y-4 shadow-xl">
            <div className="w-16 h-16 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center justify-center mx-auto text-2xl mb-2">
              <CheckCircle />
            </div>
            <h3 className="text-2xl font-bold text-white">
              Detailed Review Hidden
            </h3>
            <p className="text-emerald-100/60 max-w-md mx-auto leading-relaxed font-semibold">
